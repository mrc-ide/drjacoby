...
df_params <- data.frame() |>
  add_parameter(name = "N_0", min = 1, max = 100) |>
  add_parameter(name = "r", min = 1, max = 2) |>
  add_parameter(name = "N_max", min = 50, max = 200)
```
...
output <- mcmc$output(phase = "sample")
param_draws <- output[seq(1, nrow(output), 30) , df_params$name]
