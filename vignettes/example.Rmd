...
cpp_loglike_string <- "SEXP loglike(std::vector<double> params, std::vector<double> x) {
...
In conclusion, if efficiency is your goal then C++ versions of *both* the likelihood and prior should be used. If ease of programming is more important then R versions of these functions should suffice.
