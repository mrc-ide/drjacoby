...
cc <- parallel::clusterEvalQ(
  ...
  expr =  cpp11::cpp_source(
    system.file("extdata", "cpp_likelihood_and_prior_functions.cpp", package = "drjacoby")
    )
)
cpp11::cpp_source(system.file("extdata", "cpp_likelihood_and_prior_functions.cpp", package = "drjacoby"))
```
