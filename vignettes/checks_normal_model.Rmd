...
**Purpose:** to compare *drjacoby* infered posterior distribution against the exact analytical solution for a very simple model of Normally distributed data.
...
```{r}
cpp_funcs <- system.file("extdata/checks/", "normal_loglike_logprior.cpp", package = 'drjacoby', mustWork = TRUE)
