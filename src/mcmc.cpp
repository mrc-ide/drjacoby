...
list mcmc(
    ...
    const bool silent,
    // Parameters
    const doubles_matrix<> theta_init,
    const strings theta_names,
    const integers transform_type,
    const doubles theta_min,
    const doubles theta_max,
    const integers infer_parameter,
    ...
    const doubles_matrix<> proposal_sd_init,
    const integers_matrix<> acceptance_init,
