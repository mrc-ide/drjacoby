...
// code.cpp
list mcmc(const int chain, const bool burnin, const int iterations, const bool silent, doubles theta_init, strings theta_names, integers transform_type, doubles theta_min, doubles theta_max, integers infer_parameter, list data, function ll_f, function lp_f, writable::list misc, doubles_matrix<> proposal_sd_init, integers_matrix<> acceptance_init, double target_acceptance, bool swap, doubles beta_init, const integers swap_acceptance_init, list blocks_list, const int n_unique_blocks, const int iteration_counter_init, cpp11::sexp rng_ptr);
...
extern "C" SEXP _drjacoby_rngt(SEXP ptr, SEXP chain) {
  BEGIN_CPP11
    return cpp11::as_sexp(rngt(cpp11::as_cpp<cpp11::decay_t<cpp11::sexp>>(ptr), cpp11::as_cpp<cpp11::decay_t<int>>(chain)));
  END_CPP11
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_drjacoby_rngt", (DL_FUNC) &_drjacoby_rngt,  2},
    {NULL, NULL, 0}
};
}
