...
extern "C" SEXP _drjacoby_mcmc(SEXP theta_init, SEXP theta_names, SEXP transform_type, SEXP theta_min, SEXP theta_max, SEXP blocks_list, SEXP n_unique_blocks, SEXP data, SEXP burnin, SEXP samples, SEXP ll_f, SEXP lp_f, SEXP target_acceptance, SEXP misc, SEXP n_rungs, SEXP beta_init, SEXP swap) {
  BEGIN_CPP11
...
static const R_CallMethodDef CallEntries[] = {
    {"_drjacoby_mcmc", (DL_FUNC) &_drjacoby_mcmc, 17},
    {NULL, NULL, 0}
};
}
