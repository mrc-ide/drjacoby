...
// mcmc.cpp
list mcmc(const int chain, const bool burnin, const int iterations, const bool silent, doubles_matrix<> theta_init, strings theta_names, integers transform_type, doubles theta_min, doubles theta_max, integers infer_parameter, list data, function ll_f, function lp_f, writable::list misc, doubles_matrix<> proposal_sd_init, integers_matrix<> acceptance_init, double target_acceptance, int swap, doubles beta_init, const integers swap_acceptance_init, list blocks_list, const int n_unique_blocks, const int iteration_counter_init, cpp11::sexp rng_ptr);
