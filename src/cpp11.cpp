...
// code.cpp
list mcmc(doubles theta_init, strings theta_names, integers transform_type, doubles theta_min, doubles theta_max, list blocks_list, int n_unique_blocks, list data, int burnin, int samples, function ll_f, function lp_f, double target_acceptance, writable::list misc, int n_rungs, doubles beta_init, bool swap, integers infer_parameter);
extern "C" SEXP _drjacoby_mcmc(SEXP theta_init, SEXP theta_names, SEXP transform_type, SEXP theta_min, SEXP theta_max, SEXP blocks_list, SEXP n_unique_blocks, SEXP data, SEXP burnin, SEXP samples, SEXP ll_f, SEXP lp_f, SEXP target_acceptance, SEXP misc, SEXP n_rungs, SEXP beta_init, SEXP swap, SEXP infer_parameter) {
  BEGIN_CPP11
...
static const R_CallMethodDef CallEntries[] = {
    {"_drjacoby_mcmc", (DL_FUNC) &_drjacoby_mcmc, 18},
    {NULL, NULL, 0}
};
}
